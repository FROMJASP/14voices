...
if (hasValidS3) {
  console.log('S3 is configured, including S3ClientUploadHandler in import map');
} else {
  console.log(
    'S3 is not configured (dummy values detected), excluding S3ClientUploadHandler from import map'
  );
}
