        ...
        <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
                Kies uit 250+ professionele stemacteurs. Bekroond door onze klanten met een 4.9/5
                score.
              </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 italic mb-3">
                  &quot;Uitstekende service! Snelle levering en de stem was precies wat we zochten
                  voor onze campagne.&quot;
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <blockquote className="text-2xl text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                  &quot;De kwaliteit en snelheid van 14voices is ongeëvenaard. Perfect voor onze
                  deadlines!&quot;
                </blockquote>
                <div className="flex items-center gap-4">
