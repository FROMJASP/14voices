...
import { Headphones, ArrowRight, Play, Mic, Radio, Waves, Sparkles } from 'lucide-react';
...
// Enhanced grain texture generator
...
const variations = [
  {
    ...
    description: 'Transform your story into a symphony of synthetic warmth. Every voice crafted with precision, delivered with soul.',
    cta: 'Start je reis',
    gradient: {
  ...
  },
  {
    ...
    description: 'Blend vintage aesthetics with cutting-edge audio. Your message deserves the perfect voice, delivered in record time.',
    cta: 'Pulse forward',
    gradient: {
  ...
  },
  {
    ...
    description: 'Strip away the noise, amplify the message. Clean, crisp, and compelling voice-overs that resonate.',
  ...
  },
  {
    ...
    description: 'Vibrant voices that paint neon across the digital canvas. Every project becomes an audiovisual masterpiece.',
    cta: 'Ride the wave',
    gradient: {
  ...
  },
  {
    ...
    description: 'Embrace the beautiful imperfections. Where glitches become features and chaos creates character.',
    cta: 'Harmonize now',
    gradient: {
...
export function AnalogDreamsGSAPVariations() {
  ...
  return (
    <div ref={containerRef} className={`relative min-h-screen overflow-hidden transition-colors duration-700 ${
          ...
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              index === currentVariation 
                ? 'bg-gradient-to-r ' + (theme === 'dark' ? variation.accent.dark : variation.accent.light) + ' scale-150'
      ...
      <div className="absolute inset-0">
        <div className={`float-element absolute top-20 left-10 w-64 h-64 rounded-full filter blur-3xl bg-gradient-to-r ${
          theme === 'dark' ? variation.accent.dark : variation.accent.light
        } opacity-20`} />
        <div className={`float-element absolute bottom-20 right-20 w-96 h-96 rounded-full filter blur-3xl bg-gradient-to-r ${
          theme === 'dark' ? variation.accent.dark : variation.accent.light
        } opacity-15`} />
        <div className={`float-element absolute top-1/2 left-1/2 w-80 h-80 rounded-full filter blur-3xl bg-gradient-to-r ${
          theme === 'dark' ? variation.accent.dark : variation.accent.light
        } opacity-25`} />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 sm:px-12 lg:px-20">
        <div className="max-w-5xl mx-auto w-full">
          ...
          <div className="analog-content flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-12">
            <div className={`analog-step px-8 py-4 backdrop-blur-md rounded-2xl border transition-all duration-300 ${
              theme === 'dark' 
          ...
          {/* Subtitle */}
          <h2 className={`analog-content text-2xl mb-6 ${
          ...
          <p className={`analog-content text-xl mb-12 max-w-2xl ${
          ...
          {/* Enhanced CTA Button */}
          <button className={`analog-content group px-10 py-5 rounded-full font-bold text-lg hover:scale-105 transition-all inline-flex items-center gap-4 shadow-2xl bg-gradient-to-r ${
            theme === 'dark' ? variation.accent.dark : variation.accent.light
