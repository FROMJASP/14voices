...
export function PricingMockup4() {
    ...
    <section className="relative min-h-screen py-24 px-4 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          animate={{
            backgroundImage: [
              'radial-gradient(circle at 20% 50%, #18f109 0%, transparent 50%)',
              'radial-gradient(circle at 80% 50%, #efd243 0%, transparent 50%)',
              'radial-gradient(circle at 20% 50%, #18f109 0%, transparent 50%)',
            ],
          }}
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-4 font-['Plus_Jakarta_Sans']">
          ...
          {pricingCards.map((card, index) => {
            ...
            return (
              ...
              >
                {/* Glow effect */}
                <motion.div
                  className={`absolute inset-0 bg-gradient-to-r ${card.gradient} rounded-3xl blur-2xl opacity-50`}
                  animate={{ 
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className={`w-full py-4 rounded-xl font-semibold text-white bg-gradient-to-r ${card.gradient} relative overflow-hidden group`}
                    >
                  ...
                  {[...Array(3)].map((_, i) => (
                    <motion.div
                      key={i}
                      className={`absolute w-1 h-1 bg-gradient-to-r ${card.gradient} rounded-full`}
                      style={{
                        left: `${20 + i * 30}%`,
                        top: `${80 + i * 5}%`,
                      }}
