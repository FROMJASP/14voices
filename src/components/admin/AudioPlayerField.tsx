  ...
  return (
    <div style={{ 
      ...
      <h4 style={{ 
        ...
        Audio Preview {!isLoaded && <span style={{ color: '#999', fontWeight: 'normal' }}>(Loading...)</span>}
      </h4>
      ...
      <div style={{ 
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '50%',
            border: 'none',
            backgroundColor: isLoaded ? '#1db954' : '#ccc',
            color: 'white',
          ...
          onMouseUp={(e) => isLoaded && (e.currentTarget.style.transform = 'scale(1)')}
          onMouseEnter={(e) => isLoaded && (e.currentTarget.style.backgroundColor = '#1ed760')}
          onMouseLeave={(e) => isLoaded && (e.currentTarget.style.backgroundColor = '#1db954')}
        >
          {isPlaying ? '⏸' : '▶'}
        </button>
