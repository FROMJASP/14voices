...
const NavIconsCSS: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Note: Productions create button icon fix is now handled in admin-overrides.css
    ...
    // No additional sidebar height CSS needed here - handled in admin-overrides.css
