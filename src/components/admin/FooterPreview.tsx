...
import { Footer as FooterClient } from '@/components/sections/Footer';
  ...
  return (
    <div className="space-y-6 p-6 bg-muted/10 rounded-lg">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">Live Footer Preview</h3>
        ...
        <div className="flex justify-center overflow-x-auto">
          ...
          >
            ...
            >
              ...
              {/* Footer Preview */}
              <FooterClient navItems={formattedNavItems} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="text-sm text-muted-foreground">
        <p>This preview shows how your footer will appear with the current navigation settings.</p>
        <p className="mt-1">The footer automatically inherits your main menu items.</p>
      </div>
    </div>
  );
};
