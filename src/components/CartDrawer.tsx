      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed right-0 top-0 bottom-0 w-full max-w-md bg-white dark:bg-card shadow-2xl z-[60] ${plusJakarta.variable} font-plus-jakarta overflow-hidden`}
            style={{ height: '100vh' }}
          >
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={`fixed bottom-6 right-6 z-40 ${plusJakarta.variable} font-plus-jakarta`}
        >
          <motion.button
