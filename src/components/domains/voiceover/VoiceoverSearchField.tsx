...
import { RotatingText } from '@/components/common/widgets/RotatingText';
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-8 sm:pt-16 lg:pt-20 pb-4 sm:pb-8 lg:pb-16 relative z-20">
            ...
            <div className="flex items-center justify-center gap-4 mb-4 sm:mb-8 flex-wrap sm:flex-nowrap">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-bricolage" style={{ color: 'var(--text)' }}>
                  Upload script
                </span>
              </div>
            ...
            <h1 className="text-center mb-4 sm:mb-8 animate-fadeInUp">
              ...
              <span className="block font-bricolage text-3xl sm:text-3xl lg:text-4xl xl:text-5xl font-light text-title mt-2 sm:mt-4 tracking-normal leading-tight text-center">
                voor jouw{' '}
                <RotatingText
                  text={[
                    'project',
            ...
            {/* Subtitle */}
            <p className="font-bricolage text-lg sm:text-xl font-normal text-center mb-6 sm:mb-10 lg:mb-12 max-w-2xl mx-auto leading-relaxed tracking-normal text-gray-600 dark:text-gray-400">
              Op zoek naar een professioneel voice-over? Vind een Nederlandse stemacteur die jouw
              merk{' '}
              <span className="font-medium text-gray-800 dark:text-gray-200">laat spreken</span>!
            </p>
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-6 lg:gap-8 mb-4 sm:mb-8 flex-wrap">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className="font-bricolage text-base font-semibold whitespace-nowrap"
                  style={{ color: 'var(--text)' }}
                >
                  &lt;48u levering
                </span>
