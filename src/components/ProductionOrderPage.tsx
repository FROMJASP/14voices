...
export const ProductionOrderPage = React.memo(function ProductionOrderPage({ 
  ...
  const fontClasses = `${plusJakarta.variable} ${instrumentSerif.variable} bg-background`;
  ...
  const handleProductionChange = useCallback((newSlug: string) => {
      ...
      <div className="min-h-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div>
            ...
            <h1 className="text-3xl lg:text-4xl font-bold mb-4" style={{ fontFamily: 'var(--font-instrument-serif)' }}>
              {production.name}
            </h1>
                            ...
                            <button
                              ...
                              onClick={() => {
                                setSelectedVoiceover({
                                  ...
                                  styleTags: voice.styleTags?.map(st => st.customTag || st.tag) || [],
                                });
                            ...
                            >
                              ...
                              <div className="flex-1 text-left">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                  {voice.styleTags?.slice(0, 3).map(st => st.customTag || st.tag).join(', ')}
                                </p>
                              </div>
                              {selectedVoiceover?.id === voice.id && (
                ...
                <div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 space-y-2">
                    {production.itemlistThree.map((option) => {
                      ...
                      const isDisabled = option.dependencies?.some((dep) => !selectedOptions.has(dep)) ?? false;
