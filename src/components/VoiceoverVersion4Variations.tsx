...
export function VoiceoverVersion4Variations() {
  ...
  return (
    <div
      className={`space-y-24 bg-gray-50 dark:bg-gray-900 ${plusJakarta.variable} font-plus-jakarta`}
    >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
                Ontdek 250+ stemacteurs. Direct beschikbaar voor jouw commercial, documentaire of
                bedrijfsvideo.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Professionele opnames in top studio&apos;s
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Niet tevreden? Gratis herziening
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  We helpen je de perfecte stem te vinden
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
      ...
      <div className="bg-black">
        ...
        <div className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-20">
            <div
              className="absolute inset-0 bg-[#18f109]"
              style={{
          ...
          <div className="relative z-10 text-center px-6 py-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-12">
              Van impactvolle commercials tot meeslepende documentaires. Vind de perfecte stem voor
              jouw verhaal.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#18f109]/10 rounded-full mb-6">
                ...
                <span className="text-sm font-medium text-[#18f109]">
                  Marktleider in voice-overs
                </span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-6">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
                Werk samen met Nederland&apos;s beste stemacteurs. Direct beschikbaar, professioneel
                en betaalbaar.
              </p>
              ...
              <div className="flex items-center gap-6">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full border-2 border-white dark:border-gray-950"
                    />
                  ))}
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <span className="font-semibold text-gray-900 dark:text-white">500+</span> tevreden
                  klanten
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#fcf9f5] to-[#fafafa] dark:from-gray-900 dark:to-gray-800 p-8 rounded-2xl">
                ...
                <blockquote className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  &quot;14voices heeft onze commercial naar een hoger niveau getild. De perfecte
                  stem, snelle levering en uitstekende kwaliteit. Een aanrader!&quot;
                </blockquote>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Direct beschikbaar voor jouw project
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {sampleVoices.map((voice) => (
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Filter op stijl, taal of project type
                </p>
              </div>
              <div className="flex gap-2">
