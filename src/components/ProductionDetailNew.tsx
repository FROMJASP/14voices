  ...
  },
  {
    ...
    itemlistThree: [
      ...
      },
      {
        ...
        price: 75,
        infoText:
          'Wil je dat jouw script op beeld wordt ingespreken? Stuur ons je video en we dubben de voice-over onder het beeld, zodat je qua timing altijd goed zit!',
      },
    ],
  },
  {
...
export function ProductionDetailNew({ productionIndex }: ProductionDetailNewProps) {
  ...
  const handleProductionChange = (newSlug: string) => {
  ...
  return (
    <div
      className={`${plusJakarta.variable} ${instrumentSerif.variable} font-plus-jakarta min-h-screen bg-background`}
    >
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="lg:sticky lg:top-8">
            <div
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl flex flex-col"
              style={{ height: '560px' }}
            >
                            ...
                            <button
                              ...
                              onClick={() => {
                                setSelectedVoiceover({
                                  id: voice.id,
                                  name: voice.name,
                                  profilePhoto: voice.profilePhoto?.url || undefined,
                                  styleTags:
                                    voice.styleTags?.map((tag) => tag.tag || tag.customTag || '') ||
                                    [],
                                });
