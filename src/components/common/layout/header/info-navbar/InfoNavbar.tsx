  ...
  const renderWhatsAppLink = () => {
    ...
    const whatsAppContent = (
      ...
      >
        ...
        <span className="whitespace-nowrap text-xs lg:text-[13px]">
          {data.whatsappNumber}
        </span>
      </Link>
    );
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <GlimpseTitle>{data.whatsappTooltip?.title || 'Stuur ons een WhatsApp'}</GlimpseTitle>
              </div>
              <GlimpseDescription>
                {data.whatsappTooltip?.message || 'We zijn vaak in de studio aan het werk. Stuur ons eerst een WhatsApp-bericht, dan kunnen we je zo snel mogelijk terugbellen.'}
              </GlimpseDescription>
            </div>
          </div>
        </GlimpseContent>
