...
import { BeautifulAudioPlayer } from '@/components/widgets/media';
...
export function VoiceoverShowcaseClient({
  ...
  return (
    <section
      id="voiceovers"
      className={`py-20 bg-[#fcf9f5] dark:bg-[#1a1a1a] text-gray-900 dark:text-white ${bricolageGrotesque.variable}`}
    >
      <div className="container mx-auto px-4">
        ...
        <div className="mb-20">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <h2 className="font-bricolage text-7xl md:text-8xl font-black leading-[0.85] mb-8">
              ...
              <div className="bg-white dark:bg-gray-800 p-2 rounded-2xl shadow-sm dark:shadow-xl border border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-14 pr-5 py-4 bg-gray-50 dark:bg-gray-700 rounded-xl focus:outline-none focus:bg-white dark:focus:bg-gray-600 transition-colors font-bricolage text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                  />
                </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-12">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bricolage text-2xl font-semibold">Uit het archief</h3>
            <button className="flex items-center gap-2 text-sm font-bricolage text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Bekijk alle stemmen
                    ...
                    <div className="w-full aspect-square bg-gray-100 dark:bg-gray-700 rounded-lg mb-3 flex items-center justify-center relative">
                      ...
                      {!voice.beschikbaar && (
                        <div className="absolute inset-0 bg-white/70 dark:bg-black/70 rounded-lg flex items-center justify-center">
                          <span className="text-xs font-bricolage font-semibold text-gray-700 dark:text-gray-300">
                            {voice.availabilityText}
                          </span>
                        </div>
                      )}
                    </div>
                    <h4 className="font-bricolage font-semibold mb-1 text-gray-900 dark:text-white">
                      {voice.name}
                    </h4>
                  </Link>
