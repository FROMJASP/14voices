...
export const DrawerHeader = React.memo(
  forwardRef<HTMLButtonElement, DrawerHeaderProps>(
    ({ title, onClose, showDragHandle = true, className = '' }, ref) => {
      return (
        <>
          ...
          <div
            className={`flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex-shrink-0 ${className}`}
          >
