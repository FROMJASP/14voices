...
import { Star, Zap, Shield, Sparkles, Crown, Heart, Users, Baby, Smile, Briefcase, Mic, Flame, Sun } from 'lucide-react';
...
export function VoiceoverSearchFieldDesign({ voiceovers }: VoiceoverSearchFieldDesignProps) {
  ...
  const filteredVoiceovers = useMemo(() => {
    return randomizedVoiceovers.filter(voice => {
      ...
      if (!selectedStyles.includes('Alle stijlen') && selectedStyles.length > 0) {
        const hasSelectedStyle = voice.tags.some(tag => selectedStyles.includes(tag));
  ...
  return (
    <div className={`min-h-screen bg-white dark:bg-background ${plusJakarta.variable} ${instrumentSerif.variable} font-plus-jakarta`}>
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-8 sm:pt-16 lg:pt-20 pb-4 sm:pb-8 lg:pb-16 relative z-20">
          ...
          <div className="flex items-center justify-center gap-4 mb-4 sm:mb-8 flex-wrap sm:flex-nowrap">
            ...
            <div className="flex items-center gap-2 text-sm">
              <span className="w-8 h-8 bg-white dark:bg-card border border-border rounded-full flex items-center justify-center font-semibold text-normal">2</span>
            ...
            <div className="flex items-center gap-2 text-sm w-full sm:w-auto justify-center">
              <span className="w-8 h-8 bg-white dark:bg-card border border-border rounded-full flex items-center justify-center font-semibold text-normal">3</span>
          ...
          <h1 className="text-center mb-4 sm:mb-8 animate-fadeInUp">
            <span className="block font-instrument-serif text-7xl sm:text-6xl lg:text-7xl xl:text-8xl font-normal text-title leading-[0.9] tracking-tight">
              De <span className="text-[#18f109] italic hover:text-[#18f109]/80 transition-colors duration-300">ideale</span> stem
            </span>
          ...
          <p className="text-lg sm:text-lg lg:text-xl text-center text-normal mb-6 sm:mb-10 lg:mb-12 max-w-2xl mx-auto leading-relaxed tracking-normal">
            Op zoek naar een professioneel voice-over? Vind een Nederlandse stemacteur die jouw merk <span className="font-medium text-title">laat spreken</span>!
          </p>
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-6 lg:gap-8 mb-4 sm:mb-8 flex-wrap">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm sm:text-base font-semibold whitespace-nowrap text-normal">&lt;48u levering</span>
            </div>
            ...
            >
              ...
              <span className="text-sm sm:text-base font-semibold whitespace-nowrap text-normal">9.1/10 beoordeeld</span>
            </a>
            <div className="w-px h-5 bg-border" />
            <div className="flex items-center gap-1.5">
              <Shield className="w-5 h-5 sm:w-5 sm:h-5 text-[#ebaa3a]" />
              <span className="text-sm sm:text-base font-semibold whitespace-nowrap text-normal">100% garantie</span>
            </div>
          </div>
