...
const variations = [
  {
    ...
    description:
      'Transform your narrative into luminous soundscapes that pulse with creative energy',
  ...
  },
  {
    ...
    description:
      'Craft audio experiences that echo through digital dimensions and nostalgic futures',
  ...
  },
  {
    ...
    description:
      'Blend authentic storytelling with fluid soundscapes that breathe life into your content',
    cta: 'Flow Into Sound',
    icon: Waves,
    gradient: {
  ...
  },
  {
    ...
    description:
      'Deconstruct traditional voiceovers into avant-garde audio art that defies convention',
...
export function AnalogDreamsVariations() {
  ...
  return (
    <div
      className={`min-h-screen ${theme === 'dark' ? 'bg-black' : 'bg-white'} transition-colors duration-500`}
    >
