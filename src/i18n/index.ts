  ...
  supportedLanguages: {
    nl: {
      ...
      translations: {
        ...
        'authentication:checkYourEmailForPasswordReset': 'Controleer uw e-mail voor een link om uw wachtwoord te resetten.',
        ...
        'authentication:forgotPasswordEmailInstructions': 'Voer uw e-mailadres hieronder in en wij sturen u instructies om uw wachtwoord te resetten.',
        ...
        'authentication:generatingNewAPIKeyWillInvalidate': 'Het genereren van een nieuwe API sleutel zal alle bestaande API sleutels <1>ongeldig maken</1>. Weet u het zeker?',
        'authentication:lockUntil': 'Vergrendelen tot',
        'authentication:loggedIn': 'U bent nu ingelogd.',
        'authentication:loggedInChangePassword': 'U bent nu ingelogd. Om uw wachtwoord te wijzigen, ga naar uw <0>Account</0> en bewerk uw wachtwoord daar.',
        ...
        'authentication:loginWithAnotherUser': 'Om als andere gebruiker in te loggen, moet u eerst <0>uitloggen</0>.',
        ...
        'authentication:youAreReceivingResetPassword': 'U ontvangt dit omdat u (of iemand anders) een reset van het wachtwoord voor uw account heeft aangevraagd. Klik op de onderstaande link, of plak deze in uw browser om het proces te voltooien:',
        'authentication:youDidNotRequestPassword': 'Als u dit niet heeft aangevraagd, negeer dan deze e-mail en uw wachtwoord blijft ongewijzigd.',
...
export function getCollectionLabels(collection: string) {
  return {
    singular: {
      nl: nlTranslations.collections[collection as keyof typeof nlTranslations.collections]?.singular || collection,
      en: enTranslations.collections[collection as keyof typeof enTranslations.collections]?.singular || collection,
    },
    plural: {
      nl: nlTranslations.collections[collection as keyof typeof nlTranslations.collections]?.plural || collection,
      en: enTranslations.collections[collection as keyof typeof enTranslations.collections]?.plural || collection,
    },
  }
}
