  ...
  supportedLanguages: {
    nl: {
      ...
      translations: {
        ...
        // Lexical editor translations
        'lexical:link:editLink': 'Link bewerken',
        'lexical:link:enterURL': 'Voer URL in',
        'lexical:link:url': 'URL',
        'lexical:link:internalLink': 'Interne link',
        'lexical:link:externalLink': 'Externe link',
        'lexical:link:emailLink': 'E-mail link',
        'lexical:link:phoneLink': 'Telefoon link',
        'lexical:link:anchor': 'Anker',
        'lexical:link:customURL': 'Aangepaste URL',
      },
    },
    en: {
      label: 'English',
      translations: {
        ...
        // Lexical editor translations
        'lexical:link:editLink': 'Edit link',
        'lexical:link:enterURL': 'Enter URL',
        'lexical:link:url': 'URL',
        'lexical:link:internalLink': 'Internal link',
        'lexical:link:externalLink': 'External link',
        'lexical:link:emailLink': 'Email link',
        'lexical:link:phoneLink': 'Phone link',
        'lexical:link:anchor': 'Anchor',
        'lexical:link:customURL': 'Custom URL',
      },
    },
  },
  defaultLanguage: 'nl',
