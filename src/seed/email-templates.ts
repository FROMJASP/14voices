...
export async function seedEmailTemplates(payload: Payload) {
      ...
      content: {
        root: {
          children: [
            {
              type: 'paragraph',
              children: [{ text: '14voices - Professional Voice Over Services' }],
            },
          ],
        },
      },
  ...
  await payload.create({
    ...
    data: {
      ...
      content: {
        root: {
          children: [
            ...
            {
              type: 'paragraph',
              children: [{ text: "Here's what you can do next:" }],
            },
            {
              type: 'paragraph',
              children: [{ text: '• Browse our talented voice over artists' }],
            },
            {
              type: 'paragraph',
              children: [{ text: '• Create your first booking' }],
            },
            {
              type: 'paragraph',
              children: [{ text: '• Upload your scripts securely' }],
            },
            {
              type: 'paragraph',
              children: [
      ...
      variables: [{ key: 'userName', description: "User's name", required: true }],
      testData: {
        userName: 'John Doe',
      ...
      content: {
        root: {
          children: [
            ...
            {
              type: 'paragraph',
              children: [{ text: 'Your booking has been confirmed!' }],
            },
            {
              type: 'paragraph',
              children: [{ text: 'Booking Details:' }],
            },
            {
              type: 'paragraph',
              children: [{ text: '• Voice Over Artist: {{voiceoverName}}' }],
            },
            {
              type: 'paragraph',
              children: [{ text: '• Booking ID: {{bookingId}}' }],
            },
            {
              type: 'paragraph',
              children: [{ text: '• Date: {{bookingDate}}' }],
            },
            {
              type: 'paragraph',
            ...
            {
              type: 'paragraph',
              children: [{ text: '1. Upload your script in the booking dashboard' }],
            },
            {
              type: 'paragraph',
              children: [
            ...
            {
              type: 'paragraph',
              children: [{ text: "3. You'll be notified when the recording is ready" }],
            },
            {
              type: 'paragraph',
              children: [{ text: 'Thank you for choosing 14voices!' }],
            },
          ],
        },
      },
