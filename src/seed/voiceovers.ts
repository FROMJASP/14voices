...
export const seedVoiceovers = async (payload: Payload): Promise<void> => {
  ...
  const voiceovers = [
    ...
    },
    {
      ...
      description: 'Diepe, resonante stem met internationale ervaring. Perfect voor luxe merken en premium producties.',
      styleTags: [
        { tag: 'autoriteit' },
        { tag: 'warm-donker' },
        { tag: 'kwaliteit' },
    ...
    {
      name: 'Anna Visser',
      description: 'Veelzijdige stem voor karakters en animaties. Van kinderboeken tot spelletjes, brengt elk personage tot leven.',
      styleTags: [
        { tag: 'jeugdig-fris' },
    ...
    {
      name: 'Mark de Groot',
      description: 'Ervaren radiomaker en voice-over. Natuurlijke presentatiestijl met uitstekende improvisatievaardigheden.',
      styleTags: [
        { tag: 'zakelijk' },
        { tag: 'stoer' },
        { tag: 'custom', customTag: 'Radio' },
      ],
      status: 'more-voices',
      availability: {
        isAvailable: true,
