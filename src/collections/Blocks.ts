  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Team Grid', value: 'teamGrid' },
        ...
        { label: 'Team Display', value: 'teamDisplay' },
        { label: 'Portfolio Display', value: 'portfolioDisplay' },
      ],
    },
    // Hero Banner
    {
    ...
    // Team Display
    {
      ...
      type: 'group',
      admin: {
        condition: (data) => data.blockType === 'teamDisplay',
      },
      fields: [
        {
          name: 'headline',
        ...
        },
        {
          ...
          admin: {
            condition: (data, siblingData) => siblingData?.source === 'department',
          },
        },
        {
    ...
    // Portfolio Display
    {
      ...
      type: 'group',
      admin: {
        condition: (data) => data.blockType === 'portfolioDisplay',
      },
      fields: [
        {
          name: 'headline',
